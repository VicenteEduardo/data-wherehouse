                                                                    ...
                                                                    <strong>
                                                                        <span style="font-size: 25px; line-height: 38px;">
                                                                            ...
                                                                            @else
                                                                                ...
                                                                                Fomento a Invenção Inovação e Empreendedorismo Sustentável
                                                    ...
                                                    <tr>
                                                        <td style="overflow-wrap:break-word;word-break:break-word;padding:10px;font-family:'Open Sans',sans-serif;"
                                                            ...
                                                            <div class="v-text-align"
                                                                style="color: #615e5e; line-height: 140%; text-align: left; word-wrap: break-word;">
                                                                <p style="font-size: 14px; line-height: 140%;"><span
                                                                        style="font-size: 14px; line-height: 19.6px;">E-mail</span>
                                                                </p>
                                                            </div>
                                                    ...
                                                    <tr>
                                                        <td style="overflow-wrap:break-word;word-break:break-word;padding:10px;font-family:'Open Sans',sans-serif;"
                                                            ...
                                                            <div class="v-text-align"
                                                                style="color: #615e5e; line-height: 140%; text-align: right; word-wrap: break-word;">
                                                                <p style="font-size: 14px; line-height: 140%;"><span
                                                                        style="font-size: 14px; line-height: 19.6px;">{{ $signup['email'] }}</span>
                                                                </p>
                                                            </div>
                                                        ...
                                                        <td style="overflow-wrap:break-word;word-break:break-word;padding:16px;font-family:'Open Sans',sans-serif;"
                                                            ...
                                                            <div class="v-text-align"
                                                                ...
                                                                <p style="font-size: 14px; line-height: 140%;">&copy;
                                                                    ...
                                                                    Fomento a Invenção Inovação e Empreendedorismo Sustentável</p>
                                                            </div>
