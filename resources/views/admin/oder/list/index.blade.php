    ...
    <div class="card mb-2">
        <div class="col-lg-12">
            ...
            <div class="card-body row">
                <div class="col-md-10">
                    <h5><b> Lista de Minhas Encomendas</b></h5>
                </div>
                ...
                <tbody class="bg-white">
                    ...
                    @foreach ($orders as $item)
                        <tr class="text-center text-dark">
                            ...
                            <td>
                                @if ($item->status != 'Pago')
                                    <a href="/admin/pedidos-compras/pagamentos/{{ $item->id }}"><img width="110"
                                            src="/Site/img/payment/money.png" alt=""> </a>
                                @else
                                    Já pagou está factura
                                @endif
                            ...
                            <td>
                                <div class="dropdown">
                                    ...
                                    <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                        ...
                                        <a href='{{ url("admin/pedidos-compras/show/{$item->id}") }}'
                                            class="dropdown-item">Detalhes</a>

                                        <a target="_blank" href='{{ url("admin/encomenda-clientes/print/{$item->id}") }}'
                                            class="dropdown-item">Imprimir Recibo</a>
                                        <a href='{{ url("admin/pedidos-compras/delete/{$item->id}") }}'
